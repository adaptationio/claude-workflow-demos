---
description: Reproduce, fix, and verify a single reported bug via subagents. Recreation of the built-in bugfix workflow (native Workflow tool is gated off in your org).
...
1. Read the full recipe at `${CLAUDE_PLUGIN_ROOT}/skills/bugfix/SKILL.md`.
